      ...
      <div v-for="event in filteredEvents" :key="event.id" class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-6">
          <div class="flex justify-between items-start mb-2">
            ...
            <span :class="statusClass(getEventStatus(event))" class="px-2 py-1 rounded-full text-xs font-medium">
...
const { events, getEventsByStatus, formatEventDateShort, getEventStatus } = useEvents()
